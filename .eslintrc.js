module.exports = {
	...
	rules: {
		...
		'@typescript-eslint/no-use-before-define': ['off'], // 函数声明前禁止调用
		'@typescript-eslint/no-non-null-assertion': ['off'], // 禁止null类型声明
		'react/no-multi-comp': ['off'],
		'react/forbid-elements': ['off'],
		'prefer-rest-params': ['off'],
		'taro/props-reserve-keyword': ['off'],
